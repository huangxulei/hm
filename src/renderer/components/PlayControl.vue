...
const { togglePlaybackQueueView, hideCategoryView } = useMainViewStore()
...
<template>
    <div class="play-ctl">
        ...
        <div class="play-prev-btn spacing" @click="playPrevTrack">
            <svg width="15" height="15" viewBox="0 0 24 28.01" xmlns="http://www.w3.org/2000/svg">
                <g id="Layer_2" data-name="Layer 2">
                    <g id="Layer_1-2" data-name="Layer 1">
                        <g id="Layer_2-2" data-name="Layer 2">
                            <path
                                d="M1.2,28a1.12,1.12,0,0,0,1.2-1V16L22.09,27.81a1.37,1.37,0,0,0,1.68-.21A.92.92,0,0,0,24,27V1a1.11,1.11,0,0,0-1.2-1,1.45,1.45,0,0,0-.71.19L2.4,12V1A1.12,1.12,0,0,0,1.2,0,1.12,1.12,0,0,0,0,1V27A1.12,1.12,0,0,0,1.2,28Z" />
                        </g>
                    </g>
                </g>
            </svg>
        ...
        <div class="play-btn spacing" @click="togglePlay">
            ...
            <svg v-show="playing" width="24" height="24" class="paused" viewBox="0 0 100 100" xml:space="preserve"
                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <path
                    d="M44.2,78.3H32.1c-1.1,0-2-0.9-2-2V23.7c0-1.1,0.9-2,2-2h12.1c1.1,0,2,0.9,2,2v52.5C46.2,77.4,45.3,78.3,44.2,78.3z" />
                <path
                    d="M67.9,78.3H55.8c-1.1,0-2-0.9-2-2V23.7c0-1.1,0.9-2,2-2h12.1c1.1,0,2,0.9,2,2v52.5C69.9,77.4,69,78.3,67.9,78.3z" />
            </svg>
        </div>
            ...
            <svg width="15" height="15" viewBox="0 0 24 28.01" xmlns="http://www.w3.org/2000/svg">
                <g id="Layer_2" data-name="Layer 2">
                    <g id="Layer_1-2" data-name="Layer 1">
                        <g id="Layer_2-2" data-name="Layer 2">
                            <path
                                d="M22.8,0a1.12,1.12,0,0,0-1.2,1V12L1.91.19A1.37,1.37,0,0,0,.23.41.89.89,0,0,0,0,1V27a1.12,1.12,0,0,0,1.2,1,1.36,1.36,0,0,0,.71-.2L21.6,16V27A1.22,1.22,0,0,0,24,27V1A1.12,1.12,0,0,0,22.8,0Z" />
                        </g>
                    </g>
                </g>
            </svg>
        ...
        <div class="playlist-btn spacing" @click.stop="togglePlaybackQueue">
            <svg width="26" height="26" viewBox="3 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <title />
